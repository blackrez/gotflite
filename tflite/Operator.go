...
func (rcv *Operator) BuiltinOptionsType() byte {
...
func (rcv *Operator) MutateBuiltinOptionsType(n byte) bool {
...
func (rcv *Operator) CustomOptionsFormat() int8 {
...
func (rcv *Operator) MutateCustomOptionsFormat(n int8) bool {
	return rcv._tab.MutateInt8Slot(16, n)
}

func (rcv *Operator) MutatingVariableInputs(j int) byte {
...
func OperatorAddBuiltinOptionsType(builder *flatbuffers.Builder, builtinOptionsType byte) {
	builder.PrependByteSlot(3, builtinOptionsType, 0)
}
...
func OperatorAddCustomOptionsFormat(builder *flatbuffers.Builder, customOptionsFormat int8) {
