...
func (rcv *Pool2DOptions) Padding() int8 {
...
func (rcv *Pool2DOptions) MutatePadding(n int8) bool {
...
func (rcv *Pool2DOptions) FusedActivationFunction() int8 {
...
func (rcv *Pool2DOptions) MutateFusedActivationFunction(n int8) bool {
...
func Pool2DOptionsAddPadding(builder *flatbuffers.Builder, padding int8) {
...
func Pool2DOptionsAddFusedActivationFunction(builder *flatbuffers.Builder, fusedActivationFunction int8) {
