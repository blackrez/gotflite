...
func (rcv *Conv2DOptions) Padding() int8 {
...
func (rcv *Conv2DOptions) MutatePadding(n int8) bool {
...
func (rcv *Conv2DOptions) FusedActivationFunction() int8 {
...
func (rcv *Conv2DOptions) MutateFusedActivationFunction(n int8) bool {
...
func Conv2DOptionsAddPadding(builder *flatbuffers.Builder, padding int8) {
...
func Conv2DOptionsAddFusedActivationFunction(builder *flatbuffers.Builder, fusedActivationFunction int8) {
