...
func (rcv *TransposeConvOptions) Padding() int8 {
...
func (rcv *TransposeConvOptions) MutatePadding(n int8) bool {
...
func TransposeConvOptionsAddPadding(builder *flatbuffers.Builder, padding int8) {
