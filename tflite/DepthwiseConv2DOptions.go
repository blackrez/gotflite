...
func (rcv *DepthwiseConv2DOptions) Padding() int8 {
...
func (rcv *DepthwiseConv2DOptions) MutatePadding(n int8) bool {
...
func (rcv *DepthwiseConv2DOptions) FusedActivationFunction() int8 {
...
func (rcv *DepthwiseConv2DOptions) MutateFusedActivationFunction(n int8) bool {
...
func DepthwiseConv2DOptionsAddPadding(builder *flatbuffers.Builder, padding int8) {
...
func DepthwiseConv2DOptionsAddFusedActivationFunction(builder *flatbuffers.Builder, fusedActivationFunction int8) {
