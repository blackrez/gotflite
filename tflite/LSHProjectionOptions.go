...
func (rcv *LSHProjectionOptions) Type() int8 {
...
func (rcv *LSHProjectionOptions) MutateType(n int8) bool {
...
func LSHProjectionOptionsAddType(builder *flatbuffers.Builder, type_ int8) {
