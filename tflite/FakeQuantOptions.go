...
func (rcv *FakeQuantOptions) NarrowRange() byte {
...
func (rcv *FakeQuantOptions) MutateNarrowRange(n byte) bool {
...
func FakeQuantOptionsAddNarrowRange(builder *flatbuffers.Builder, narrowRange byte) {
	builder.PrependByteSlot(3, narrowRange, 0)
}
